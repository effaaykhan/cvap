...
- [Recurring findings](recurring-findings.md) — 14 defect classes: self-asserted fields, intra-tenant IDOR, unimplemented contract MUSTs, untrusted values in typed columns, stream teardown deadlocks.
