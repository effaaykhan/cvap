...
- [Recurring findings](recurring-findings.md) — 23 defect classes: self-asserted fields, intra-tenant IDOR, unimplemented contract MUSTs, unsolicited acks, stop-races-start, replaced-not-retired secrets, claimed-but-absent conformance suites.
